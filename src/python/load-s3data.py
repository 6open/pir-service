...
def load_s3_data():
    ...
    pir_server = "http://192.168.50.162:12601/v1/service/pir/setup"
    print(requset_data)
...
if __name__ == '__main__':
    print(".....load-s3data.....")
    logging.basicConfig(filename='s3-help.log', level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s')
    app.run(debug=True, host='0.0.0.0', port=12602)
