...
#include "src/pir/pir_client/pir_client_factory.h"
#include "src/pir/pir_server/pir_server_factory.h"
#include "src/pir/pir_data_handler/pir_data_handler_factory.h"
...
void PirManager::Setup(const PirSetupRequest* request,PirSetupResponse* response)
{
    ...
    //     return;
    // }
    // data_handler->Setup(request,response);
}
...
{
    std::string str = request->algorithm()+"_"+request->data();
