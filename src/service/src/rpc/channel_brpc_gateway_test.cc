...
class ChannelBrpcGatewayTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
//bazel test //src/rpc:channel_brpc_gateway_test --test_filter=ChannelBrpcGatewayTest.Normal_Empty
TEST_F(ChannelBrpcGatewayTest, Normal_Empty) {
...
TEST_F(ChannelBrpcGatewayTest, Timeout) {
...
TEST_F(ChannelBrpcGatewayTest, Normal_Len100) {
  const std::string key = "key";
